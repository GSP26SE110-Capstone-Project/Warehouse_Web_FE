...
export const CategoryModal: React.FC<Props> = ({
    ...
    // Định nghĩa các biến Style đồng bộ Layout Tối (Dark Mode)
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            {/* Backdrop làm mờ mượt hơn trên nền tối */}
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/50">
                    <div>
                        <h2 className="text-base font-bold text-slate-100 flex items-center gap-2">
                            ...
                            {isCreate ? 'Tạo danh mục mới' : isView ? 'Chi tiết danh mục' : 'Cập nhật danh mục'}
                        </h2>
                    </div>
